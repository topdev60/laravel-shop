@extends('frontend.'.domain_info('user_id').'.saka-cart.layouts.app')
@push('css')
<link rel="stylesheet" href="{{ asset('frontend/'.domain_info('user_id').'/saka-cart/css/slick.css') }}">
<link rel="stylesheet" href="{{ asset('frontend/'.domain_info('user_id').'/saka-cart/css/lightgallery.css') }}">
@endpush
@section('content')
...
@endsection
@push('js')
<script src="{{ asset('frontend/'.domain_info('user_id').'/saka-cart/js/elevateZoom.js') }}"></script>
<script src="{{ asset('frontend/'.domain_info('user_id').'/saka-cart/js/lightgallery.js') }}"></script>
<script src="{{ asset('frontend/'.domain_info('user_id').'/saka-cart/js/details.js') }}"></script>
@endpush