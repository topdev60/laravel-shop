                        ...
                        <div class="single-product-info">
                            ...
                            <div class="single-product-meta">
                                ...
                                <div class="single-product-price">
                                    ...
                                    <h3><del>{{ amount_format_store($info->price->regular_price) }}</del> <span id="amount">{{ amount_format_store($info->price->price) }}</span></h3>
                                    @else
                                    <h3 id="amount">{{ amount_format_store($info->price->price) }}</h3>
                                    @endif
                                </div>
                            ...
                            <div class="single-product-widget product-quantity">
                                ...
                                <ul>
                                 ...
                                 <p class="my-3"><b>Estimated Delivery Date : </b>{{ $order_days->estimated_order_days }}</p>
...
@endsection   
@push('js')
<script src="{{ asset('frontend/'.domain_info('user_id').'/bigbag/js/product/details.js')}}"></script>
@endpush