...
@push('css')
<link rel="stylesheet" href="{{ asset('frontend/'.domain_info('user_id').'/bigbag/css/register.css') }}">
@endpush  
@section('content')    
<!--=====================================
...
@endsection
@push('js')
 <script src="{{ asset('frontend/'.domain_info('user_id').'/bigbag/js/register.js')}}"></script>
@endpush