...
@push('css')
<link rel="stylesheet" href="{{ asset('frontend/'.domain_info('user_id').'/bigbag/css/jquery-ui.css')}}">
@endpush  
@section('content')    
<!--=====================================
...
@endsection      
@push('js')
<script src="{{ asset('frontend/'.domain_info('user_id').'/bigbag/js/jquery-ui.js')}}"></script>
<script src="{{ asset('frontend/'.domain_info('user_id').'/bigbag/js/shop.js')}}"></script>
