...
<!--=====================================
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <ul class="header-content header-widget">
                            ...
                            var_dump($currencies);
                            $default = $currencies['currency_default']->currency_name;
                            @endphp
                            <li class="dropdown">
                                <a href="#"><i class="fas fa-globe text-danger"></i>{{ __('currency') }}</a>
                                <ul class="dropdown-menu header-dropdown">
                                    <li><a class="dropdown-item @if($default == Session::get('to_currency')) active_language text-white @endif" href="{{url('/set_to_currency?'.'default='.$default.'&to='.$default)}}">{{$default.'  (default)'}}</a></li>
                                    @foreach($currencies['currency_name'] as $key=> $value)
                                    <li><a class="dropdown-item @if($key == Session::get('to_currency')) active_language text-white @endif" href="{{url('/set_to_currency?'.'default='.$default.'&to='.$key)}}">{{$key}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="container">
                    ...
                    <ul class="cart-list overflow-auto" >
                        ...
                        <li class="cart-item cart-row{{ $row->rowId }}">
                            ...
                            <div class="cart-info">
                                ...
                                <p>{{ $row->qty }} x <span>{{ amount_format_store($row->price) }}</span></p>
                            </div>
                    ...
                    <ul class="cart-price">
                        <li>
                            ...
                            <span id="cart_sub_total">{{ amount_format_store($cart_subtotal) }}</span>
                        </li>
                        <li>
                            <span>{{ __('Total') }}:</span>
                            <span id="cart_total">{{ amount_format_store($cart_total) }}</span>
                        </li>
                    </ul>
                    <ul class="cart-btn">
        ...
        <section class="left-sidebar">
            <div class="left-sidebar-cover sidebar-cover">
                ...
                <li>
                    <a href="/blogs" target="_blank"><span>Blogs</span></a>
                </li>
            </ul>
