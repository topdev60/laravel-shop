				...
				<form method="post" action="{{ route('admin.plan.update',$info->id) }}" class="basicform">
					...
					<div class="row">
						<div class="col-sm-8">
							...
							<div class="form-group">
								<label>{{ __('Total Emails') }}</label>
								<input type="number" value="{{ $plan_info->total_emails }}"  name="total_emails" class="form-control" required> 
							</div>
						...
						<div class="col-sm-4">
							...
							<div class="form-group">
								<label>{{ __('Live Shipping Rates') }}</label>
								<select class="form-control" name="live_rates">
									<option @if($info->live_rates  == true || $info->live_rates  == 'true') selected @endif  value=true >{{ __('Enable') }}</option>
									<option  @if($info->live_rates  == false || $info->live_rates  == 'false') selected @endif value=false >{{ __('Disable') }}</option>
								</select>
							</div>
							...
							<div class="form-group">
								...
								<select class="form-control" name="blog">
									<option @if($plan_info->blog  == true || $plan_info->blog  == 'true') selected @endif  value=true >{{ __('Enable') }}</option>
									<option  @if($plan_info->blog  == false || $plan_info->blog  == 'false') selected @endif value=false >{{ __('Disable') }}</option>
								</select>
							</div>
							<div class="form-group">
